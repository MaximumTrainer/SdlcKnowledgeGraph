<!-- GENERATED FROM docs/adr/0008-dependency-updates.md - DO NOT EDIT. Run `npm --prefix website run generate`. -->

# ADR-0008: Dependency updates arrive continuously, and the toolchain tracks supported majors

## Status

Accepted. Implemented by [#68](https://github.com/MaximumTrainer/SdlcKnowledgeGraph/issues/68).

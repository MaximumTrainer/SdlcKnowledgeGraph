<!-- GENERATED FROM docs/adr/0003-hybrid-ontology-registry.md - DO NOT EDIT. Run `npm --prefix website run generate`. -->

# ADR-0003: A hybrid ontology, with a registry as the source of truth

## Status

Accepted. Implemented by [#18](https://github.com/MaximumTrainer/SdlcKnowledgeGraph/issues/18), [#19](https://github.com/MaximumTrainer/SdlcKnowledgeGraph/issues/19) and
[#20](https://github.com/MaximumTrainer/SdlcKnowledgeGraph/issues/20).

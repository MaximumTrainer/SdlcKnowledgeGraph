<!-- GENERATED FROM docs/adr/0006-website-generated-from-sources.md - DO NOT EDIT. Run `npm --prefix website run generate`. -->

# ADR-0006: The website is generated from repository sources

## Status

Accepted. Implemented by [#43](https://github.com/MaximumTrainer/SdlcKnowledgeGraph/issues/43).
...
committed and held in place by `ontologyDriftCheck` ([ADR-0003](/adr/0003-hybrid-ontology-registry)).
The pacts are generated, committed and diffed in CI ([ADR-0004](/adr/0004-pact-folder-no-broker)).
